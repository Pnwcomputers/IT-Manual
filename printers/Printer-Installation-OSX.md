...
4.  If not, download and install any needed printer device drivers/software: [**Install Printer Drivers & Software**](https://pnwcomputers.blogspot.com/2025/05/official-printer-scanner-driver.html)
...
2.  Use the printer’s built-in menu to connect it to Wi-Fi (e.g., Settings $\rightarrow$ Network $\rightarrow$ Wireless Setup Wizard).
3.  *(Optional)* If your printer supports **WPS**, press the WPS button on your router and start WPS mode on your printer.
4.  Complete the printer setup on the system by installing any needed printer device drivers & software: [**Install Printer Drivers & Software**](https://pnwcomputers.blogspot.com/2025/05/official-printer-scanner-driver.html)
...
3.  Complete the printer setup on the system by installing any needed printer device drivers & software: [**Install Printer Drivers & Software**](https://pnwcomputers.blogspot.com/2025/05/official-printer-scanner-driver.html)
...
1.  Click **Apple menu () $\rightarrow$ System Settings $\rightarrow$ Printers \& Scanners**.
...
4.  [**Install Printer Drivers & Software**](https://pnwcomputers.blogspot.com/2025/05/official-printer-scanner-driver.html) macOS may install drivers automatically. If not, download the latest drivers from the manufacturer’s website.
...
2.  Click **File $\rightarrow$ Print** and select your printer.
...
* **Need Manufacturer Software?** Download drivers from HP, Canon, Brother, Epson, etc., [official websites.](https://pnwcomputers.blogspot.com/2025/05/official-printer-scanner-driver.html)
